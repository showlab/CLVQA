# --- seq distil gpt2, use sampled sg
CUDA_VISIBLE_DEVICES=0 python train.py --cl_setting scene --task_seq abcdef --model_name distilgpt2 --model_dir_root  /Users/stan/exp/clvqa/QAG_seq/not_use_gt/QAG_scene_task_token   --add_task_tokens --n_train_epochs 15
