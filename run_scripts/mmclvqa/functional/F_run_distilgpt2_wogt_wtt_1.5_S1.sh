...
python -c 'from eval_os import *; stage_sweep(cl_setting="functional", setting_idx=1, abbr_seq="oarlks", device="'${DEVICE}'", model_name="unicl", save_dir="'${ROOT}'/exp/clvqa", val_exp="distilgpt2_replay_qag_seq_not_use_gt_task_token_1.5", test_stand_alone=False, test_reg=False)' 
