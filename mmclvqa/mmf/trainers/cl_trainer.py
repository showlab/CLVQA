...
from mmf.trainers.core.training_loop import TrainerTrainingLoopMixin, CLTrainerTrainingLoopMixin
...
@registry.register_trainer("CL")
class CLTrainer(
    TrainerCallbackHookMixin,
    CLTrainerTrainingLoopMixin,
    TrainerDeviceMixin,
    ...
    def load(self):
        ...
        # post parallalization callback, added by wx
        self.post_parallel_model_callback()
    ...
    def post_parallel_model_callback(self):
        self.cl_reg_call_back = None
        if self.config.training.CL.use_callback:
            self.cl_reg_call_back = CLCallback(self.config, self)
        
        if self.cl_reg_call_back:
            self.callbacks.append(self.cl_reg_call_back)
