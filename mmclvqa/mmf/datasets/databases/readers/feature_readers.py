...
if __name__ =='__main__':
    feature_path = '/home/stan/.cache/torch/mmf/data/datasets/textvqa/defaults/features/open_images/detectron.lmdb'
    # anno_path = '/home/stan/.cache/torch/mmf/data/datasets/textvqa/defaults/annotations/imdb_train_ocr_en.npy'
    # import numpy as np

    # anno = np.load(anno_path, allow_pickle=True)
    # item = anno[1]
    # img_feat_path = feature_path+ '/train/' + item['feature_path']

    # import ipdb; ipdb.set_trace()
    # myreader = LMDBFeatureReader(max_loc=100, base_path=feature_path)
    ...
    with env.begin(write=False, buffers=True) as txn:
        value = txn.get(b'test/537e3c1613806f01')
        all_keys = txn.get(b'keys')
        import ipdb; ipdb.set_trace()
